...
public class Enemy_3 : Enemy // Enemy_3 extends the Enemy class
{
    ...
    void Start()
    {
        ...
        //Pick a random final position aboe the top of the screen
    ...
    {
        //Bezier vurces work based on a u value between 0 & 1
