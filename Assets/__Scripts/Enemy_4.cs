...
public class Enemy_4 : Enemy // Enemy_4 extends the Enemy class
{
    ...
    void Start()
    {
        ...
        //Initially set p0 p1 to the current poisition (from Main.SpawnEnemy())
        p0 = p1 = pos;
        InitMovement();
    }
    ...
    void InitMovement()
    {
        ...
        // Make sure that it moves to a different quadrant of the sccreen
    ...
    public override void Move()
    {
        ...
        u = u - .15f * Mathf.Sin(u * 2 * Mathf.PI); // Easing: Sine -0.15
