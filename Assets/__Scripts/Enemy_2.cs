...
public class Enemy_2 : Enemy // Enemy_2 extends the Enemy class
{
    ...
    void Start()
    {
        ...
        {
            // Seting the .x of each point to its negative will move it to the other side of the screen
            p0.x *= -1;
            p1.x *= -1;
        }
    ...
    public override void Move()
    {
        ...
        //Interpolate the two linear intepolation points
        pos = (1 - u) * p0 + u * p1;
        
        // Note that Enemy_2 does NOT call the base.Move() metho
    }
}
